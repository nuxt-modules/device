...
function isMobileOrTablet (a): boolean {
  return REGEX_MOBILE_OR_TABLET1.test(a) || REGEX_MOBILE_OR_TABLET2.test(a.substr(0, 4))
}

function isIos (a): boolean {
  return /iPad|iPhone|iPod/.test(a)
}

function isAndroid (a): boolean {
  return /android/i.test(a)
}

function isWindows (a): boolean {
  return /Windows/.test(a)
}

function isMacOS (a): boolean {
...
function getBrowserName (a): string {
